                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="addrecordform" action="record!add.action" namespace="/record">
                                        <div class="form-group">
                                        	<div class="input-group">
	                                        	<span class="input-group-addon">用户账号</span>
	                                        	<s:textfield cssClass="form-control " type="text" id="user" name="usercode"></s:textfield>
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                        	<div class="input-group">
	                                        	<span class="input-group-addon">输入图书索书号</span>
	                                        	<s:textfield cssClass="form-control " type="text" id="book" name="bookssh"></s:textfield>
                                        	</div>
                                        </div>
                                    </form>
                                </div>
