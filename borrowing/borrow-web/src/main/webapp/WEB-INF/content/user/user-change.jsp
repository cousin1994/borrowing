                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="changeform" action="user!changePSW.action" namespace="/user">
                                        <div class="form-group">
                                        	<div class="input-group">
	                                        	<span class="input-group-addon">输入旧密码</span>
	                                        	<s:textfield cssClass="form-control " type="password" id="user" name="oldpsw"></s:textfield>
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                        	<div class="input-group">
	                                        	<span class="input-group-addon">输入新密码</span>
	                                        	<s:textfield cssClass="form-control " type="password" id="user" name="newpsw"></s:textfield>
                                        	</div>
                                        </div>
                                    </form>
                                </div>
