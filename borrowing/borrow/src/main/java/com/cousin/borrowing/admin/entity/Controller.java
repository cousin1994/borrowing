package com.cousin.borrowing.admin.entity;
...
/**
 * Controller entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CONTROLLER", schema = "BORROW")
public class Controller implements java.io.Serializable {
	...
	/** full constructor */
	public Controller(String adcode, String adpassword, String adname,
